...
$page_title = 'Vaisselle Porcelaine';
$page_description = 'Vaisselle Porcelaine Blanche - Élégante et raffinée';
$page_keywords = 'location vaisselle porcelaine, porcelaine blanche, location vaisselle élégante';
...
<section id="devis" style="background: linear-gradient(135deg, #D97706 0%, #B45309 100%); color: white; text-align: center; margin-top: 3rem;">
    <div class="container">
        <h2 style="color: white;">Intéressé par la <?php echo $gamme['nom']; ?> ?</h2>
        <p>Demandez un devis gratuit dès maintenant !</p>
        <a href="<?php echo SITE_URL; ?>/pages/contact.php" class="btn btn-primary" style="background: white; color: #D97706; font-weight: 600;">Demander un devis</a>
    </div>
</section>
