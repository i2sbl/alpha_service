...
$page_title = 'Gamme Prestige';
$page_description = 'Découvrez notre gamme Prestige: porcelaine haut de gamme avec décor or et argent';
$page_keywords = 'location vaisselle prestige, location porcelaine décorée, location vaisselle luxe';
...
<!-- ===== CALL TO ACTION ===== -->
<section id="devis" style="background: linear-gradient(135deg, #0D9488 0%, #047857 100%); color: white; text-align: center; margin-top: 3rem;">
    <div class="container">
        <h2 style="color: white;">Intéressé par la gamme <?php echo $gamme['nom']; ?> ?</h2>
        <p>Demandez un devis gratuit dès maintenant !</p>
        <a href="<?php echo SITE_URL; ?>/pages/contact.php" class="btn btn-primary" style="background: white; color: #0D9488; font-weight: 600;">Demander un devis</a>
    </div>
</section>
