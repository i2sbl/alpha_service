...
$page_title = 'Verrerie';
$page_description = 'Verrerie - Verres et flûtes de qualité';
$page_keywords = 'location verres, location flûtes, location verrerie';
...
<section id="devis" style="background: linear-gradient(135deg, #0D9488 0%, #047857 100%); color: white; text-align: center; margin-top: 3rem;">
    <div class="container">
        <h2 style="color: white;">Intéressé par notre verrerie ?</h2>
