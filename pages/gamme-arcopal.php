...
$page_title = 'Gamme Arcopal';
$page_description = 'Découvrez notre gamme Arcopal: verrerie robuste et porcelaine opaque';
$page_keywords = 'location vaisselle arcopal, location porcelaine, location verrerie robuste';
...
<!-- ===== CALL TO ACTION ===== -->
<section id="devis" style="background: linear-gradient(135deg, #7C3AED 0%, #6D28D9 100%); color: white; text-align: center; margin-top: 3rem;">
    <div class="container">
        <h2 style="color: white;">Intéressé par la gamme <?php echo $gamme['nom']; ?> ?</h2>
        <p>Demandez un devis gratuit dès maintenant !</p>
        <a href="<?php echo SITE_URL; ?>/pages/contact.php" class="btn btn-primary" style="background: white; color: #7C3AED; font-weight: 600;">Demander un devis</a>
    </div>
</section>
