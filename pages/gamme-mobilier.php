...
$page_title = 'Mobilier';
$page_description = 'Mobilier de location - Tables et chaises';
$page_keywords = 'location tables, location chaises, location mobilier';
...
<section id="devis" style="background: linear-gradient(135deg, #059669 0%, #047857 100%); color: white; text-align: center; margin-top: 3rem;">
    <div class="container">
        <h2 style="color: white;">Intéressé par notre mobilier ?</h2>
        <p>Demandez un devis gratuit dès maintenant !</p>
        <a href="<?php echo SITE_URL; ?>/pages/contact.php" class="btn btn-primary" style="background: white; color: #059669; font-weight: 600;">Demander un devis</a>
    </div>
</section>
