...
$page_description = 'Découvrez nos formules packs complets et économiques';
$page_keywords = 'formules location, packs vaisselle, location formules';
        ...
        <div class="grid grid-4">
            ...
            <div class="card">
                ...
                <div style="margin-top: 0.5rem; font-size: 0.85rem; color: #999;">
                    <span><?php echo $produit['pieces']; ?> pièces</span>
                </div>
            </div>
            <?php endforeach; ?>
        </div>
...
<section id="devis" style="background: linear-gradient(135deg, #8B5CF6 0%, #7C3AED 100%); color: white; text-align: center; margin-top: 3rem;">
    <div class="container">
        <h2 style="color: white;">Intéressé par nos formules ?</h2>
