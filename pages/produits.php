    ...
    <div class="container">
            ...
            <div class="grid grid-4">
                <div class="card">
                    <div class="product-media">
                        <img class="product-img" src="<?php echo SITE_URL; ?>/assets/images/porcelaine%2020.jpg" alt="Assiettes Standard">
                    </div>
                ...
                <div class="card">
                    <div class="product-media">
                        <img class="product-img" src="<?php echo SITE_URL; ?>/assets/images/carr%C3%A9%20verre.jpg" alt="Verres Standard">
                    </div>
                ...
                <div class="card">
                    <div class="product-media">
                        <img class="product-img" src="<?php echo SITE_URL; ?>/assets/images/filet%2031.jpg" alt="Couverts Standard">
                    </div>
                ...
                <div class="card">
                    <div class="product-media">
                        <img class="product-img" src="<?php echo SITE_URL; ?>/assets/images/tasse%20sous%20tasse%20carr%C3%A9.jpg" alt="Tasses Standard">
                    </div>
        ...
        <div style="margin-bottom: 3rem; background: #f8f9fa; padding: 2rem; border-radius: 8px;">
            ...
            <div class="grid grid-4">
                <div class="card">
                    <div class="product-media">
                        <img class="product-img" src="<?php echo SITE_URL; ?>/assets/images/assiette%20rectangle.png" alt="Assiettes Arcopal">
                    </div>
                ...
                <div class="card">
                    <div class="product-media">
                        <img class="product-img" src="<?php echo SITE_URL; ?>/assets/images/carr%C3%A9%20verre.jpg" alt="Verres Savoie">
                    </div>
                    <h4>Verres Savoie</h4>
                ...
                <div class="card">
                    <div class="product-media">
                        <img class="product-img" src="<?php echo SITE_URL; ?>/assets/images/saladier.jpg" alt="Bols Arcopal">
                    </div>
                    <h4>Bols Arcopal</h4>
                ...
                <div class="card">
                    <div class="product-media">
                        <img class="product-img" src="<?php echo SITE_URL; ?>/assets/images/tasse%20sous%20tasse%20filet.png" alt="Tasses Arcopal">
                    </div>
        ...
        <div style="margin-bottom: 3rem;">
            ...
            <div class="grid grid-4">
                <div class="card">
                    <div class="product-media">
                        <img class="product-img" src="<?php echo SITE_URL; ?>/assets/images/porcelaine%2025.jpg" alt="Assiettes Premium">
                    </div>
                ...
                <div class="card">
                    <div class="product-media">
                        <img class="product-img" src="<?php echo SITE_URL; ?>/assets/images/porcelaine%2028.jpg" alt="Verres Premium">
                    </div>
                ...
                <div class="card">
                    <div class="product-media">
                        <img class="product-img" src="<?php echo SITE_URL; ?>/assets/images/martelee%2028.jpg" alt="Couverts Premium">
                    </div>
                ...
                <div class="card">
                    <div class="product-media">
                        <img class="product-img" src="<?php echo SITE_URL; ?>/assets/images/tasse%20sous%20tasse%20martelee.png" alt="Tasses Premium">
                    </div>
        ...
        <div style="margin-bottom: 1rem; background: #f0fdfa; padding: 2rem; border-radius: 8px;">
            ...
            <div class="grid grid-4">
                <div class="card">
                    <div class="product-media">
                        <img class="product-img" src="<?php echo SITE_URL; ?>/assets/images/assiette%20peintre.jpg" alt="Assiettes Prestige">
                    </div>
                ...
                <div class="card">
                    <div class="product-media">
                        <img class="product-img" src="<?php echo SITE_URL; ?>/assets/images/carr%C3%A9%20verre.jpg" alt="Verres Prestige">
                    </div>
                ...
                <div class="card">
                    <div class="product-media">
                        <img class="product-img" src="<?php echo SITE_URL; ?>/assets/images/martelee%2022.jpg" alt="Couverts Prestige">
                    </div>
                ...
                <div class="card">
                    <div class="product-media">
                        <img class="product-img" src="<?php echo SITE_URL; ?>/assets/images/tasse%20sous%20tasse%20carr%C3%A9.jpg" alt="Tasses Prestige">
                    </div>
