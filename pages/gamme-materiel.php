...
$page_title = 'Matériel & Équipements';
$page_description = 'Équipements de location pour vos événements';
$page_keywords = 'location équipements, location matériel, location machine à café';
...
<section id="devis" style="background: linear-gradient(135deg, #1F2937 0%, #111827 100%); color: white; text-align: center; margin-top: 3rem;">
    <div class="container">
        <h2 style="color: white;">Intéressé par nos équipements ?</h2>
        <p>Demandez un devis gratuit dès maintenant !</p>
        <a href="<?php echo SITE_URL; ?>/pages/contact.php" class="btn btn-primary" style="background: white; color: #1F2937; font-weight: 600;">Demander un devis</a>
    </div>
</section>
